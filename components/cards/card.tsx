...
const Card1 = ({ ms, index }: { ms: ExperienceData; index: number }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <h5 className="text-zinc-500 text-sm leading-relaxed font-light z-10 group-hover:text-zinc-400 transition-colors">
                    {ms.company}
                </h5>
